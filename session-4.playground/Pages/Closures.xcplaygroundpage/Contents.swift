...
func doSomething(message: String) -> Void {
  print("\(message)")
}
doSomething(message: "HI")


//: ## Function with closure as a parameter.
func doSomethingWithCompletion(completion: (String) -> Void) -> Void {
...
//: > Swift takes some liberties with making it "clean"
//: > `doSomethingWithCompletion(completion: <#T##(String) -> Void#>)`
doSomethingWithCompletion { (aString) in
  print("HI")
}
